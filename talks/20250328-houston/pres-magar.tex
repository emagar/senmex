...
\label{sec:org5985dd6}
\begin{frame}[label={sec:orge1ce1e1}]{Team player}
\begin{columns}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org0d6b7a9}]{Three strands}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:orge2851b7}]{Three strands}
\begin{block}{Fraud, election integrity}
...
\label{sec:orgf5ad7d8}
\begin{frame}[label={sec:org06f19ad}]{In the back burner since 2014}
\begin{itemize}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:orga8db9b7}]{Problems}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org1eff8ba}]{What surfaced}
\begin{itemize}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:org76f6359}]{Against bill universe}
\begin{center}
\begin{tabular}{lrrr}
...
\label{sec:orgda388ab}
\begin{frame}[label={sec:orgffb7e92},fragile]{Public repository}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:orge48c7a1}]{.}
\centering 
